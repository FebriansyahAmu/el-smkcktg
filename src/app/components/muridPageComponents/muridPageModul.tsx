...
export default function MuridPageModul({ moduls, idCourse }: props) {
  return (
      ...
      <main className="flex-1 w-full max-w-7xl p-9 mx-auto py-8">
        <section className="mb-8">
          <div className="flex items-center text-sm text-gray-500 flex-wrap">
            <Link href={`../${idCourse}`} className="hover:text-indigo-600">
              Dashboard Kelas
            </Link>
            ...
            <div className="flex flex-col md:flex-row bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="w-full md:w-2/3 p-6 flex flex-col justify-between">
                ...
                <div className="flex mt-4 w-full">
                  <Link
                    href={`modul/${modul.id_modules}`}
                    className="w-full text-center px-6 py-2 bg-white border border-indigo-600 text-indigo-600 hover:bg-indigo-50 rounded-lg text-sm font-medium transition duration-300"
                  >
                    Buka Modul
                  </Link>
                </div>
